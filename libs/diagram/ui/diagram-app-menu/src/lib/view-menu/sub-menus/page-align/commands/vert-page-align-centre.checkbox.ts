...
export class VertPageAlignCentreCheckbox extends PageAlignBase {
  private item = this.mb.checkboxItem({
    label: 'Vertical Centre',
    checked$: this.pageAlignment$.pipe(map((value) => value.vertical === 'center')),
    exec: this.setPageAlignment({ vertical: 'center' }),
  });
